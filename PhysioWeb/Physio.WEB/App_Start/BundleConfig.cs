...
namespace PhysioQA
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // ionRange styles
            bundles.Add(new StyleBundle("~/bundles/ionRangeStyles").Include(
                      "~/Content/plugins/ionRangeSlider/ion.rangeSlider.css",
                      "~/Content/plugins/ionRangeSlider/normalize.css",
                      "~/Content/plugins/ionRangeSlider/ion.rangeSlider.skinHTML5.css"));

            // ionRange 
            bundles.Add(new ScriptBundle("~/bundles/ionRange").Include(
                      "~/Scripts/plugins/ionRangeSlider/ion.rangeSlider.min.js"));


            //nouislider
            bundles.Add(new ScriptBundle("~/bundles/nouislider").Include(
                     "~/Scripts/plugins/nouislider/nouislider.min.js"));

            bundles.Add(new StyleBundle("~/bundles/nouiSliderStyles").Include(
                     "~/Content/plugins/nouislider/nouislider.min.css",
                     "~/Content/plugins/nouislider/nouislider.pips.css",
                     "~/Content/plugins/nouislider/nouislider.tooltips.css"));
            ...
            // Sweet alert Styless
            bundles.Add(new StyleBundle("~/bundles/sweetAlertStyles").Include(
